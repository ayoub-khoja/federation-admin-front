      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex space-x-4">
            ...
            <button className="bg-purple-500/20 backdrop-blur-sm text-purple-300 px-6 py-3 rounded-lg hover:bg-purple-500/30 transition-all duration-300 border border-purple-500/30 flex items-center space-x-2">
              <span>📄</span>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-white/10">
                <tr>
                  <th className="px-6 py-4 text-left text-white/90 font-semibold">Arbitre</th>
                  <th className="px-6 py-4 text-left text-white/90 font-semibold">Match</th>
                  <th className="px-6 py-4 text-left text-white/90 font-semibold">Date Match</th>
                  <th className="px-6 py-4 text-left text-white/90 font-semibold">Ligue</th>
                  <th className="px-6 py-4 text-left text-white/90 font-semibold">Montant</th>
                  <th className="px-6 py-4 text-left text-white/90 font-semibold">Statut</th>
                  <th className="px-6 py-4 text-left text-white/90 font-semibold">Méthode</th>
              ...
              <tbody>
                {loading ? (
                  ...
                  paiements.map((paiement) => (
                    <tr key={paiement.id} className="border-t border-white/10 hover:bg-white/5 transition-colors">
                      <td className="px-6 py-4 text-white font-medium">{paiement.arbitre}</td>
                      <td className="px-6 py-4 text-white/80">{paiement.match}</td>
                      <td className="px-6 py-4 text-white/80">{paiement.date}</td>
                      <td className="px-6 py-4 text-white/80">{paiement.ligue}</td>
                      ...
                      <td className="px-6 py-4 text-white/80">{paiement.methode_paiement}</td>
                      <td className="px-6 py-4">
                        <div className="flex space-x-2">
                          <button className="text-blue-400 hover:text-blue-300 transition-colors" title="Voir détails">
                            👁️
                          </button>
                          <button className="text-green-400 hover:text-green-300 transition-colors" title="Marquer comme payé">
                            ✅
                          </button>
                          <button className="text-yellow-400 hover:text-yellow-300 transition-colors" title="Modifier">
                            ✏️
                          </button>
